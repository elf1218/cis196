...
1. Persistent group calendar site - can log in, create own calendar (which is stored between visits), create appointments on that calendar and edit those
...
2. Some sort of interactive game site...possibly chess - possibly internet version of correspondance chess, where you make a move, then wait for other player to
...
3. Online messenger (similar to fb messenger) including group chat - has file sharing capabilities, persistent chat history, possibly ability to edit/delete past
